...
internal object Util {
    ...
    var PAYMENTS_API_URL = "$PROTOCOL://payments.${ENVIRONMENT}pagcerto.com.br/api/v2/"
    var PAYMENTS_V3_API_URL = "$PROTOCOL://payments.${ENVIRONMENT}pagcerto.com.br/api/v3/"
    var BILLING_API_URL = "$PROTOCOL://billing.${ENVIRONMENT}pagcerto.com.br/api/v1/"
    var ACCOUNT_API_URL = "$PROTOCOL://account.${ENVIRONMENT}pagcerto.com.br/api/v2/"
    var PAYMENT_ACCOUNT_API_URL = "$PROTOCOL://payment-accounts.${ENVIRONMENT}pagcerto.com.br/api/v1/"
    var WARNINGS_API_URL = "$PROTOCOL://warnings.${ENVIRONMENT}pagcerto.com.br/api/v2/"
    var RECURRING_API_URL = "$PROTOCOL://recurring.${ENVIRONMENT}pagcerto.com.br/api/v2/"
    ...
    fun updateEnvironment(environment: String, protocol: String){
        ...
        PAYMENTS_API_URL = "$PROTOCOL://payments.${ENVIRONMENT}pagcerto.com.br/api/v2/"
        PAYMENTS_V3_API_URL = "$PROTOCOL://payments.${ENVIRONMENT}pagcerto.com.br/api/v3/"
        BILLING_API_URL = "$PROTOCOL://billing.${ENVIRONMENT}pagcerto.com.br/api/v1/"
        ACCOUNT_API_URL = "$PROTOCOL://account.${ENVIRONMENT}pagcerto.com.br/api/v2/"
        PAYMENT_ACCOUNT_API_URL = "$PROTOCOL://payment-accounts.${ENVIRONMENT}pagcerto.com.br/api/v1/"
        WARNINGS_API_URL = "$PROTOCOL://warnings.${ENVIRONMENT}pagcerto.com.br/api/v2/"
        RECURRING_API_URL = "$PROTOCOL://recurring.${ENVIRONMENT}pagcerto.com.br/api/v2/"
    }
